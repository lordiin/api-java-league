package br.com.java_league.api.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.java_league.api.service.EmailAlreadyUsedException ||
            ex instanceof br.com.java_league.api.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof br.com.java_league.api.service.InvalidPasswordException
